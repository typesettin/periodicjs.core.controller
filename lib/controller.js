...
Controller.prototype.getViewTemplate = function(options){
	...
	viewtemplate = {
		...
		viewfileext: options.viewfileext
	};
...
Controller.prototype.controller_show = function(options){
	return function (req, res) {
		...
		viewtemplate = this.getViewTemplate(options);
		...
		this.renderView(req, res, viewtemplate, viewdata);
	};
};
...
Controller.prototype.controller_index = function(options){
	return function (req, res) {
		var viewtemplate, 
			viewdata,
			viewmodel = this.getViewModelProperties(options);
...
Controller.prototype.controller_update = function (options) {
	return function(req, res){
		...
		Controller.prototype.updateModel({
			...
			originalrevision: req.controllerData.data,
...
// Controller.prototype.controller_get_return_object = function(req,res,next){

// };

Controller.prototype.controller_load_model = function (req, res, next) {
...
Controller.prototype.getItemsData = function(options){
	var parallelTask = {},
 		req = options.req,
		res = options.res,
...
Controller.prototype.controller_model_query = function(options){
	return function (req, res, next) {
		...
		Controller.prototype.getItemsData({
			req: req,
			res: res,
			next: next,
			population: population,
