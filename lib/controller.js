...
// console.log('mongoId.isValid(docid)',mongoId.isValid(docid));
...
Controller.prototype.controller_model_search_query = function(options){
	var viewmodel = Controller.prototype.getViewModelProperties(options.controllerOptions),
		parallelTask = {},
 		req = options.req,
		res = options.res,
		querypagenum = parseInt(req.query.pagenum) || parseInt(req.body.pagenum) || 1,
		...
		searchRegEx = new RegExp(CoreUtilities.stripTags(req.query.search || req.body.search), 'gi'),
		parallelFilterTask = {},
		searchNameField ={},
		customSearchFields = [],
		orbuilder,
