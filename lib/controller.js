...
Controller.prototype.respondInKind=function(options){
	console.log('respondInKind periodicResources.settings',periodicResources.settings);
	var req = options.req,
		res = options.res,
		err = options.err,
	...
	if(periodicResources.settings.sessions.enabled){
...
Controller.prototype.handleDocumentQueryErrorResponse = function (options) {
	...
	if (req.query.format === 'json') {
		...
		if (options.errorflash !== false && periodicResources.settings.sessions.enabled){
